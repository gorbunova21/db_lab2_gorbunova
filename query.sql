...
-- Кількість книг кожного автора 1
SELECT authors.author_id, COUNT(books.author_id) from books JOIN authors
ON authors.author_id = books.author_id
GROUP BY authors.author_id

-- Рейтингова оцінка та кількість всіх книг, що її отрмали
